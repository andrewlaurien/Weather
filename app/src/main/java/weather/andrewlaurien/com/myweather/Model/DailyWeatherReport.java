package weather.andrewlaurien.com.myweather.Model;

import weather.andrewlaurien.com.myweather.Utilities.CommonFunc;
...
public class DailyWeatherReport {
    ...
    public DailyWeatherReport(String cityName, int currentTemp, int maxTemp, int minTemp, String weather, String country, String dateRaw) {
        ...
        this.dateString = CommonFunc.formattedDateFromString("","",dateRaw);
    }
